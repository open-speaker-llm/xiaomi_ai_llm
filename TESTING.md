...
2026-09-20 补充：整机 reboot 后自动恢复为单模型实例，安装包哈希不变；EP1 静默和 EP2 停顿轻声续说现场复验通过，随后免唤醒窗口静默退出、回到 IDLE。未手动拉起服务；断电冷启动与全天运行尚未验证，见[重启证据](docs/history/first-turn-endpoint/native-daily-20260919.md#整机重启与现场验收2026-09-20)。
